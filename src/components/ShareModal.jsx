...
export default function Modal({show, onClose, url}) {
  ...
  return (
      ...
      >
        <div
            className="rounded-lg w-[500px] bg-[#222] h-36 flex flex-col justify-around items-center"
            onClick={(e) => e.stopPropagation()}
        >
          <div className="w-full p-[10px] flex justify-around ">
          <span
              onClick={() => {
          ...
          >
            ...
            <TelegramShareButton url={url} onClick={onClose}>
